...
\item Et egrediétur diábolus ante \textbf{pe}des \textbf{e}jus.~* Stetit, et men\tinyhspace\textit{sus} \textit{est} \textbf{ter}ram.
...
\item Flúvios scindes terræ:~† vidérunt te, et dolu\textbf{é}runt \textbf{mon}tes:~* gurges a\tinyhspace\textit{quárum} \textbf{tráns}iit.
\item Dedit abýssus \textbf{vo}cem \textbf{su}am:~* altitúdo manus su\tinyhspace\textit{as} \textit{le}\textbf{vá}vit.
