...
\rubrique{\begin{enpars}
As this Sunday falls after December 17, the \normaltext{O} antiphon corresponding to the day is sung; there is no antiphon for the Sunday itself.}\end{enpars}
...
Then the usual dialogue follows.\end{enpars}}
 ...
 \rubrique{\begin{enpars}
The celebrant sings the collect of the day. The Suffrage of All Saints is omitted for all of Advent.\end{enpars}}
