...
\item Glória Pa\tinyhspace\textit{tri, et} \textit{Fí}lio,~* et Spí\textit{rítui} \textbf{San}cto.
\item Sicut erat in princípio, et \textit{nunc, et}\textbf{ sem}per,~* et in sǽcula sæ\hspace*{0.01em}\textit{culórum.} \textbf{A}men.