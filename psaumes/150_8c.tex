\item Laudáte eum in virtútibus \textbf{e}jus:~* laudáte eum secúndum multitúdinem magnitú\spurhspace\textit{dinis} \textbf{e}jus.
\item Laudáte eum in sono \textbf{tu}bæ:~* laudáte eum in psaltéri\tinyhspace\textit{o,} \textit{et} \textbf{cí}thara.
