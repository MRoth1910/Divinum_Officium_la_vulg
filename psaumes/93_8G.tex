...
\item Pópulum tuum, Dómine, humilia\textbf{vé}runt:~* et hæreditátem tuam \textit{vexa}\textbf{vé}runt.
...
\item Intellígite, insipiéntes in \textbf{pó}pulo:~* et stulti, ali\tinyhspace\textit{quándo} \textbf{sá}pite.
...
\item Ut mítiges ei a diébus \textbf{ma}lis:~* donec fodiátur pecca\tinyhspace\textit{tóri} \textbf{fó}vea.
\item Quia non repéllet Dóminus plebem \textbf{su}am:~* et hæreditátem suam non \textit{dere}\textbf{lín}quet.
\item Quoadúsque justítia convertátur in ju\textbf{dí}cium:~* et qui juxta illam omnes qui re\tinyhspace\textit{cto} \textit{sunt} \textbf{cor}de.
...
\item Nisi quia Dóminus ad\textbf{jú}vit me:~* paulo minus habitásset in inférno á\tinyhspace\textit{nima} \textbf{me}a.
\item Si dicébam: Motus est pes \textbf{me}us:~* misericórdia tua, Dómine, \textit{adju}\textbf{vá}bat me.
\item Secúndum multitúdinem dolórum meórum in corde \textbf{me}o:~* consolatiónes tuæ lætificavérunt á\tinyhspace\textit{nimam} \textbf{me}am.
