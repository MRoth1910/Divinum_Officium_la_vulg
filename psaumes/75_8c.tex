\item Et factus est in pace locus \textbf{e}jus:~* et habitátio e\myhspace\textit{jus} \textit{in} \textbf{Si}on.
...
\item De cælo audítum fecísti ju\textbf{dí}cium:~* terra trémuit \textit{et} \textit{qui}\hspace*{-0.02em}\textbf{é}vit.
\item Cum exsúrgeret in judícium \textbf{De}us,~* ut salvos fáceret omnes mansu\hspace*{0.02em}\textit{étos} \textbf{ter}ræ.
