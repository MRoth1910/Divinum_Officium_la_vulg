...
\item Splendor ejus \textbf{ut} lux \textbf{e}rit:~* córnua in má\tinyhspace\textit{nibus} \textbf{e}jus:
\item Ibi abscóndita est forti\textbf{tú}do \textbf{e}jus:~* ante fáciem \textit{ejus} \textbf{i}bit mors.
\item Et egrediétur diábolus ante \textbf{pe}des \textbf{e}jus.~* Stetit, et men\spurhspace\textit{sus} \textit{est} \textbf{ter}ram.
\item Aspéxit, et dis\textbf{sól}vit \textbf{gen}tes:~* et contríti sunt \textit{montes} \textbf{sǽ}culi.
\item Incurváti sunt \textbf{col}les \textbf{mun}di,~* ab itinéribus æterni\tinyhspace\textit{tátis} \textbf{e}jus.
\item Pro iniquitáte vidi tentória \textbf{Æ}thi\textbf{ó}piæ,~* turbabúntur pelles \textit{terræ} \textbf{Má}dian.
\item Numquid in flumínibus i\textbf{rá}tus es, \textbf{Dó}mine?~* aut in flumínibus furor tuus? vel in mari indigná\tinyhspace\textit{tio} \textbf{tu}a?
\item Qui ascéndes super \textbf{e}quos \textbf{tu}os:~* et quadrígæ tu\spurhspace\textit{æ} \textit{sal}\textbf{vá}tio.
\item Súscitans suscitábis \textbf{ar}cum \textbf{tu}um:~* juraménta tríbubus \textit{quæ} \textit{lo}\textbf{cú}tus es.
\item Flúvios scindes terræ:~† vidérunt te, et dolu\textbf{é}runt \textbf{mon}tes:~* gurges a\spurhspace\textit{quárum} \textbf{tráns}iit.
\item Dedit abýssus \textbf{vo}cem \textbf{su}am:~* altitúdo manus su\spurhspace\textit{as} \textit{le}\textbf{vá}vit.
...
\item In frémitu concul\textbf{cá}bis \textbf{ter}ram:~* et in furóre obstupefá\spurhspace\textit{cies} \textbf{gen}tes.
\item Egréssus es in salútem \textbf{pó}puli \textbf{tu}i:~* in salútem cum \textit{Christo} \textbf{tu}o.
\item Percussísti caput de \textbf{do}mo \textbf{ím}pii:~* denudásti fundaméntum ejus us\tinyhspace\textit{que} \textit{ad} \textbf{col}lum.
...
\item Viam fecísti in mari \textbf{e}quis \textbf{tu}is,~* in luto aquá\spurhspace\textit{rum} \textit{mul}\textbf{tá}rum.
...
\item Deus Dóminus forti\textbf{tú}do \textbf{me}a:~* et ponet pedes meos qua\spurhspace\textit{si} \textit{cer}\textbf{vó}rum.
\item Et super excélsa mea de\textbf{dú}cet me \textbf{vi}ctor~* in psal\tinyhspace\textit{mis} \textit{ca}\textbf{nén}tem.
