...
\item Iste Deus meus, et glorifi\textit{cábo} \textbf{e}um:~* Deus patris mei, et ex\tinyhspace\textit{altábo} \textbf{e}um.
...
\item Evaginábo glá\tinyhspace\textit{dium} \textbf{me}um,~* interf\hspace*{-0.01em}íciet e\tinyhspace\textit{os} \textit{manus} \textbf{me}a.
\item Flavit spíritus tuus, et opéruit \textit{eos} \textbf{ma}re:~* submérsi sunt quasi plumbum in a\spurhspace\textit{quis} \textit{vehe}\textbf{mén}tibus.
...
\item Et portásti eum in fortitú\textit{dine} \textbf{tu}a,~* ad habitácu\spurhspace\textit{lum} \textit{sanctum} \textbf{tu}um.
\item Ascendérunt pópuli, \textit{et} \textit{i}\textbf{rá}ti sunt:~* dolóres obtinuérunt habita\tinyhspace\textit{tóres} \textit{Phi}\textbf{lí}sthiim.
\item Tunc conturbáti sunt príncipes Edom,~† robústos Moab obtí\tinyhspace\textit{nuit} \textbf{tre}mor:~* obriguérunt omnes habi\textit{tatóres} \textbf{Chá}naan.
...
\item Introdúces eos, et plantábis in monte hæredi\tinyhspace\textit{tátis} \textbf{tu}æ,~* firmíssimo habitáculo tuo quod ope\textit{rátus} \textit{es,} \textbf{Dó}mine:
\item Sanctuárium tuum, Dómine, quod firmavérunt \textit{manus} \textbf{tu}æ.~* Dóminus regnábit in æ\tinyhspace\textit{térnum} \textit{et} \textbf{ul}tra.
\item Ingréssus est enim eques Phárao cum cúrribus et equítibus e\textit{jus} \textit{in} \textbf{ma}re:~* et redúxit super eos Dómi\tinyhspace\textit{nus} \textit{aquas} \textbf{ma}ris:
