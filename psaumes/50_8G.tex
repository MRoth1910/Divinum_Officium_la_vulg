...
\item Ecce enim veritátem dile\textbf{xí}sti:~* incérta et occúlta sapiéntiæ tuæ manife\tinyhspace\textit{stásti} \textbf{mi}hi.
...
\item Redde mihi lætítiam salutáris \textbf{tu}i:~* et spíritu principá\spurhspace\textit{li} \textit{con}\textbf{fír}ma me.
...
\item Benígne fac, Dómine, in bona voluntáte tua \textbf{Si}on:~* ut ædificéntur mu\tinyhspace\textit{ri} \textit{Je}\textbf{rú}salem.
