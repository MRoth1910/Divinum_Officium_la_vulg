...
\item Ego autem sum vermis, et non \textbf{ho}mo:~* oppróbrium hóminum, et abjé\tinyhspace\textit{ctio} \textbf{ple}bis.
\item Omnes vidéntes me deri\textbf{sé}runt me:~* locúti sunt lábiis, et mo\textit{vérunt} \textbf{ca}put.
\item Sperávit in Dómino, erípiat \textbf{e}um:~* salvum fáciat eum, quóni\tinyhspace\textit{am} \textit{vult} \textbf{e}um.
...
\item De ventre matris meæ Deus meus \textbf{es} tu,~* ne discés\spurhspace\textit{seris} \textbf{a} me:
...
\item Aperuérunt super me os \textbf{su}um:~* sicut leo rápi\tinyhspace\textit{ens} \textit{et} \textbf{rú}giens.
...
\item Quóniam circumdedérunt me canes \textbf{mul}ti:~* concílium malignánti\spurhspace\textit{um} \textit{ob}\textbf{sé}dit me.
\item Fodérunt manus meas et pedes \textbf{me}os:~* dinumeravérunt ómnia \textit{ossa} \textbf{me}a.
\item Ipsi vero consideravérunt et inspe\textbf{xé}runt me:~* divisérunt sibi vestiménta mea, et super vestem meam mi\spurhspace\textit{sérunt} \textbf{sor}tem.
...
\item Narrábo nomen tuum frátribus \textbf{me}is:~* in médio Ecclési\spurhspace\textit{æ} \textit{lau}\textbf{dá}bo te.
...
\item Edent páuperes, et saturabúntur:~† et laudábunt Dóminum qui requírunt \textbf{e}um:~* vivent corda eórum in sǽ\tinyhspace\textit{culum} \textbf{sǽ}culi.
\item Reminiscéntur et converténtur ad \textbf{Dó}minum~* univérsi \textit{fines} \textbf{ter}ræ:
\item Et adorábunt in conspéctu \textbf{e}jus~* univérsæ famí\tinyhspace\textit{liæ} \textbf{Gén}tium.
\item Quóniam Dómini est \textbf{re}gnum:~* et ipse dominá\textit{bitur} \textbf{Gén}tium.
\item Manducavérunt et adoravérunt omnes pingues \textbf{ter}ræ:~* in conspéctu ejus cadent omnes qui descén\tinyhspace\textit{dunt} \textit{in} \textbf{ter}ram.
