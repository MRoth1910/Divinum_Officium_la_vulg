\item Remisísti iniquitátem \textbf{ple}bis \textbf{tu}æ:~* operuísti ómnia peccá\tinyhspace\textit{ta} \textit{e}\textbf{ó}rum.
\item Mitigásti omnem \textbf{i}ram \textbf{tu}am:~* avertísti ab ira indignati\tinyhspace\textit{ónis} \textbf{tu}æ.
\item Convérte nos, Deus, salu\textbf{tá}ris \textbf{no}ster:~* et avérte iram tu\spurhspace\textit{am} \textit{a} \textbf{no}bis.
\item Numquid in ætérnum ira\textbf{scé}ris \textbf{no}bis?~* aut exténdes iram tuam a generatióne in gene\tinyhspace\textit{rati}\textbf{ó}nem?
\item Deus, tu convérsus vi\textbf{vi}fi\textbf{cá}bis nos:~* et plebs tua lætá\textit{bitur} \textbf{in} te.
\item Osténde nobis, Dómine, miseri\textbf{cór}diam \textbf{tu}am:~* et salutáre tu\tinyhspace\textit{um} \textit{da} \textbf{no}bis.
...
\item Etenim Dóminus dabit be\textbf{ni}gni\textbf{tá}tem:~* et terra nostra dabit \textit{fru\-ctum} \textbf{su}um.
