...
\item 8. Vota mea Dómino reddam in conspéctu omnis pópuli \textbf{e}jus:~* in átriis domus Dómini, in médio tu\tinyhspace\textit{i,} \hspace{0.02em}\textit{Je}\textbf{rú}salem.
\item 9. Glória Patri, et \textbf{Fí}lio,~* et Spirí\tinyhspace\textit{tui} \textbf{San}cto.
\item 10. Sicut erat in princípio, et nunc, et \textbf{sem}per,~* et in sǽcula sæcu\tinyhspace\textit{lórum.} \textbf{A}men.
