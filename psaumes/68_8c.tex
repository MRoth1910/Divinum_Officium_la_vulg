...
\item Quóniam propter te sustínui op\textbf{pró}brium:~* opéruit confúsio fá\tinyhspace\textit{ciem} \textbf{me}am.
\item Extráneus factus sum frátribus \textbf{me}is,~* et peregrínus f\hspace*{-0.01em}íliis \textit{matris} \textbf{me}æ.
\item Quóniam zelus domus tuæ com\textbf{é}dit me:~* et oppróbria exprobrántium tibi ceci\hspace*{0.01em}\textit{dérunt} \textbf{su}per me.
...
\item Advérsum me loquebántur, qui sedébant in \textbf{por}ta:~* et in me psallébant qui bi\tinyhspace\textit{bébant} \textbf{vi}num.
\item Ego vero oratiónem meam ad te, \textbf{Dó}mine:~* tempus beneplá\tinyhspace\textit{citi,} \textbf{De}us.
\item In multitúdine misericórdiæ tuæ ex\textbf{áu}di me,~* in veritáte sa\tinyhspace\textit{lútis} \textbf{tu}æ:
...
\item Non me demérgat tempéstas aquæ,~† neque absórbeat me pro\textbf{fún}dum:~* neque úrgeat super me púte\tinyhspace\textit{us} \textit{os} \textbf{su}um.
\item Exáudi me, Dómine, quóniam benígna est misericórdia \textbf{tu}a:~* secúndum multitúdinem miseratiónum tuárum ré\tinyhspace\textit{spice} \textbf{in} me.
\item Et ne avértas fáciem tuam a púero \textbf{tu}o:~* quóniam tríbulor, velóci\textit{ter} \textit{ex}\textbf{áu}di me.
\item Inténde ánimæ meæ, et líbera \textbf{e}am:~* propter inimícos meos \textit{éri}\hspace*{-0.01em}\textbf{pe} me.
\item Tu scis impropérium meum, et confusiónem \textbf{me}am,~* et reverén\textit{tiam} \textbf{me}am.
\item In conspéctu tuo sunt omnes qui tríbu\textbf{lant} me:~* impropérium exspectávit cor meum, \textit{et} \textit{mi}\hspace*{-0.01em}\textbf{sé}riam.
...
\item Obscuréntur óculi eórum ne \textbf{ví}deant:~* et dorsum eórum s}\textit{per} \textit{in}\textbf{cúr}va.
...
\item Ego sum pauper et \textbf{do}lens:~* salus tua, De\tinyhspace\textit{us,} \textit{sus}\textbf{cé}pit me.
\item Laudábo nomen Dei cum \textbf{cán}tico:~* et magnificábo e\tinyhspace\textit{um} \textit{in} \textbf{lau}de:
\item Et placébit Deo super vítulum no\textbf{vél}lum:~* córnua producén\textit{tem} \textit{et} \textbf{ún}gulas.
\item Vídeant páuperes et læ\textbf{tén}tur:~* quǽrite Deum, et vivet á\tinyhspace\textit{nima} \textbf{ve}stra.
\item Quóniam exaudívit páuperes \textbf{Dó}minus:~* et vinctos suos \textit{non} \textit{de}\textbf{spé}xit.
\item Laudent illum cæli et \textbf{ter}ra,~* mare et ómnia reptíli\tinyhspace\textit{a} \textit{in} \textbf{e}is.
