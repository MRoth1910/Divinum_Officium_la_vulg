...
\item Depósuit po\textbf{tén}tes de \textbf{se}de,~* et exal\textit{távit} \textbf{húmi}les.
...
\item Sicut locútus est ad \textbf{pa}tres \textbf{no}stros,~* Abraham et sémini e\hspace*{0.02em}\textit{jus} \textit{in} \textbf{sǽ}cula. textbf{sǽcu}la.
