...
\antiphona{english}{Blessed be the name of the the Lord forever}
...
\rubrique{This tone is the same on all Sundays ``of the year'' and on the three Sundays before Lent.
\end{enpars}}

\textes{fidelium_la_en}

%\rubrique{\begin{enpars}
%Then one Our Father is said, and the office is concluded with the following verses, the Marian antiphon, etc., unless Compline follows, or, in parish and other churches not bound to the office in choir, Benediction of the Blessed Sacrament or a sermon, or even some other pious exercises.\end{enpars}}
