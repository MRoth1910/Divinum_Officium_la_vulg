...
%%two letters for benediction
\indexsetup{level=\section*,toclevel=section,othercode=\footnotesize\thispagestyle{empty}}
\makeindex[name=Hy,title=index hymnorum., columns=2,columnseprule]
\makeindex[name=An,title=index antiphonarum., columns=2,columnseprule]
\makeindex[name=Va,title=index variarum., columns=2,columnseprule]
\makeindex[name=Re,title=index responsoriorum., columns=2,columnseprule]
\makeindex[name=Ps,title=index psalmorum., columns=2,columnseprule]

%%for testing
\makeindex[name=te,title=index test., columns=2,columnseprule]
...
\makeatletter
\NewDocumentCommand{\psalmusidx}{mO{}mmm}{
  %% #1 : name of the score file
  %% #2 : office part
  %% #3 :mode numeral
  %% #4 :office part letter T, H, A, P, R, F, V
