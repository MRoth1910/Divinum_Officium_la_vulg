...
\rubrique{Hymnus \normaltext{Creátor alme síderum, \pageref{creator_alme}.} \normaltext{℣. Mane nobíscum, \pageref{versiculus_adventus}.}}
 ...
 \rubrique{\begin{enpars}
The \normaltext{O} antiphon corresponding to the day is sung, as above, \normaltext{\pageref{o_antiphons}.}, as there is no antiphon for the IV Sunday of Advent, which cannot fall earlier than December 18.\end{enpars}}
...
\texteparacol{
\lettrine{E}{x}cita, quǽsumus Dómine, poténtiam tuam, et veni: et magna nobis virtúte succúrre:~† ut per auxílium grátiæ tuæ, quod nostra peccáta præpédiunt,~* indulgéntia tuæ propitiatiónis accéleret. Qui vivis et regnas.}{english}{\noindent Stir up, we beseech thee, o Lord, thy power, and come; make haste to our aid with thy great might; that, by the help of thy grace, that which is hindered by our sins may be hastened by thy merciful forgiveness. Who livest and reignest.}
\end{document}